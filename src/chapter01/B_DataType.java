    ...
    public static void main(String[] args) {
        /*
            ...
            2) 참조 타입
                ...
                - 객체나 배열과 같이 메모리의 Heap 영역에 저장된 데이터를 참조  -> 실행될 때만 값을 가져옴
         */
        ...
        // 1-4) 논리형 (데이터 값으로 true, false만을 가짐)
        ...
        // - 쌍따옴표를 사용하여 문자열을 작성
        String name = "홍길동";        // name : heap 주소값  heap : 실행시킬 때만 불러옴
        System.out.println(name);
        char charName = '이';
        System.out.println(charName);   // 그릇
    }
}
