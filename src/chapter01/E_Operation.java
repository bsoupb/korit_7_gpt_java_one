...
public class E_Operation {
    public static void main(String[] args) {
        ...
        System.out.println(21 % 10);    // 나눗셈 - 나눈 결과의 나머지를 결과

        System.out.println("=== 증감 연산자 ===");
        int number = 10;

        // 후위 증감 연산자 : 값이 계산된 후 변경됨
        System.out.println(number++);   // 10 (아직 더하기 X)
        System.out.println(number--);   // 11 (더하기 O, 뺄셈 X)
        ...
        // : 좌항과 우항과 비교한 결과를 논리(true, false) 값으로 반환
        // - <, >, <=, >=, ==, !=

        // 자바에서는 일치에 대한 연산이 ==(equals 2개)로 작성됨
