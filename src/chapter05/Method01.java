...
// cf) 자바에서의 함수
// - 자바는 객체 지향 프로그래밍 언어로, 모든 함수는 클래스에 속해 있어야 함
...
public class Method01 {
    public static void main(String[] args) {
        ...
        Calculater calculater = new Calculater();   // 객체 생성

        // 메서드 호출과 결과 출력

        System.out.println(calculater.addNumbers(10, 20));  // 30

        int result = calculater.addNumbers(50, 30);
        int result2 = calculater.addNumbers(2165867, 654);
