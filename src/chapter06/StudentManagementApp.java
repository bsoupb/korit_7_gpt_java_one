...
public class StudentManagementApp {         // 인스턴스화 되어있지 않음 
    // 메인 메서드
    ...
    public static void main(String[] args) {
        // 학생 추가
        addStudent(1, "홍길동", 28, "GPT반", 4.0);
        addStudent(2, "홍길남", 30, "IoT반", 3.8);
        addStudent(3, "홍길서", 19, "GPT반", 4.3);
        addStudent(4, "홍길순", 16, "빅데이터반", 4.1);
