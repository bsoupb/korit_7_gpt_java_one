...
public class JavaLang {
    public static void main(String[] args) {
        ...
        MyClass myClass2 = new MyClass(2, "홍길서");
        ...
        System.out.println(Math.pow(2, 3));         // 제곱값 반환 : .pow(a, b) == a의 b제곱
        System.out.println(Math.random());
        // 무작위 난수 생성 .random() - 0.0 이상 1.0 미만의 난수를 생성
