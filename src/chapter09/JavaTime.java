...
public class JavaTime {
    public static void main(String[] args) {
        ...
        // .now() - 현재 날짜 반환
        // .of(연도, 월, 일) - 특정 날짜 반환
        LocalDate today = LocalDate.now();      // now() : static 메서드
        ...
        System.out.println(now);    // 12:16:52.445820800

        LocalTime specificTime = LocalTime.of(14, 30);
        System.out.println(specificTime);   // 14:30

        LocalTime thirtyThreeMinutesLater = now.plusMinutes(33);
        System.out.println(thirtyThreeMinutesLater);    // 12:52:22.167766

        LocalTime oneHourAgo = now.minusHours(1);
        System.out.println(oneHourAgo); // 11:19:22.167766
        ...
        System.out.println(nowDateTime);        // 2024-12-05T12:24:26.678948500
        System.out.println(nowDateTime.toLocalDate());      // 2024-12-05
        System.out.println(nowDateTime.toLocalTime());      // 12:24:26.678948500

        // cf) 날짜와 시간 포맷팅(formatting)
        LocalDateTime example = LocalDateTime.now();
        System.out.println(example);        // 2024-12-05T12:28:17.882933800
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yy-MM-dd HH:mm:ss");
        System.out.println(example.format(formatter));      // 24-12-05 12:28:48
    }
}
