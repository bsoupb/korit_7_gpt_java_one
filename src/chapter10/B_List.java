...
// 새 책을 책장의 중간에 추가할 경우 - 책을 모두 한칸씩 옮겨야 함 (시간 오래걸림)
...
public class B_List {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < 100000; i++) {
            arrayListTest.add(0, i);    // 맨 앞에 삽입
        }
        long endTime = System.nanoTime();

        System.out.println("ArrayList 삽입 시간 : " + (endTime - startTime) + "ns" );   // 487509700ns
        ...
        System.out.println("LinkedList 삽입 시간 : " + (endTime - startTime) + "ns" );  // 4233900ns
