...
//    }
    ...
    public static class Builder {
        ...
        public Builder addMushrooms() {     // this -> Builder
            this.mushrooms = true;
            return this;
        }
...
public class E_Builder {
    public static void main(String[] args) {
        // Pizza noBuilderPizza = new Pizza("파인애플피자", "L", false, false, false);
        Pizza builderPizza = new Pizza.Builder("파인애플피자", "L").build();

        Pizza pizza1 = new Pizza.Builder("포테이토피자", "L")
                .addCheese()
                .build();

        Pizza pizza2 = new Pizza.Builder("콘치즈피자", "L")
                .addPepperoni()
                .addMushrooms()
                .build();
