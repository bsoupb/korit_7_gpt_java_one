...
// cf) 보일러플레이트 코드 : 프로그래밍에서 반복되는 작업니나 패턴에 대한 일종의 표준화 된 코드
...
class LombokClass {
    ...
    @NonNull
    private final String title;   // final : 반드시 초기화 (해당 생성자로 초기화) -> RequiredArgsConstructor 많이 사용됨
...
//    }
    ...
    // Builder 클래스
    // : 프로젝트 전역적인 접근이 가능
//    public static class Builder{    // 인스턴스화 되기 전에 사용
