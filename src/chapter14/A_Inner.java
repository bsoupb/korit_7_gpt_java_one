...
class OuterClass {
    ...
    static class StaticClass {
        void display() {
            // 외부 클래스의 인스턴스 변수에 접근 X
            //System.out.println("외부 클래스 필드에 접근 : " + outField);
            
            // 외부 클래스의 정적 변수 사용 시 : 클래스명. 생략 가능
            System.out.println("외부 클래스 필드에 접근 : " + staticFIeld);
        }
    }
    ...
    void outerMethod() {
        ...
        String localFinalVar = "메서드 로컬 변수(Final)";
...
public class A_Inner {
    public static void main(String[] args) {
        ...
        staticClass.display();      // 외부 클래스 필드에 접근 : 외부 클래스의 정적 필드
