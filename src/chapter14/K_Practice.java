...
public class K_Practice {
    public static void main(String[] args) {
        List<String> fileNames = Arrays.asList(
                "documet.pdf", "image1.png", "video.mp4"
        ...
        List<String> filteredFiles = fileNames.stream()
                // .endsWith("") : 해당 문자열로 끝나는 데이터는 true로 반환
        ...
        // 정렬된 파일 : [documet.pdf, image1.png, image2.png, image3.jpg, image4.png, javascript.js, presentation.ppt, video.mp4]
    }
}
