...
public class B_Collect {
    public static void main(String[] args) {
        ...
        // prefix : 접두사
        // suffix : 접미사
        System.out.println(result);     // JAVAPYTHONJAVASCRIPT -> [JAVA, PYTHON, JAVASCRIPT]

        // Collectors.groupingBy()
        // : 특정 기준에 따라 요소를 그룹화
        Map<Character, List<String>> groupByFirstChar = uppercaseLanguages.stream()
                .collect(Collectors.groupingBy(language -> language.charAt(0)));

        System.out.println(groupByFirstChar);       // {P=[PYTHON], J=[JAVA, JAVASCRIPT]}
