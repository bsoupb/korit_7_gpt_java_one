...
public class B_ENUM {
    public static void main(String[] args) {
        ...
        // Fruits orangeFruits = Fruits.valueOf("Orange");     // IllegalArgumentException - 소문자도 같이 있어서 에러 발생
        Fruits orangeFruits = Fruits.valueOf("ORNAGE");
