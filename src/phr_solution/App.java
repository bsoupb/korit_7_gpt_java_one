    ...
    private static boolean processChoice(int choice) {
        switch (choice) {
            ...
            case 1: { // 환자 등록: 이름, 나이, 성별
                ...
                patientController.registrerPatient(requestDto);
//                boolean result = patientController.registrerPatient(requestDto);
//                if(result) {
//                    System.out.println("정상적으로 환자가 등록되었습니다");
//                } else {
//                    System.out.println("환자를 등록하지 못하였습니다");
//                }
                break;
            }
            case 2: { // 환자 정보 조회 (전체)
